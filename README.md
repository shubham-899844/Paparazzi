...
You will land on the home page. From the navigation bar, click on "Signup" to be directed to the signup portal, where you can register as a user. To log in, you’ll need to provide your email and password. Once logged in, you can explore the home page and browse available photographers based on your preferences. Select a photographer to view their details, portfolio, and pricing. If you're satisfied with their work and pricing, you can book them for a specific day or multiple days. After booking, you can initiate a video chat with the photographer through your client dashboard once they accept your request.  
